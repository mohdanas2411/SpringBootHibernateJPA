...
public class TeacherOneToMany {
    ...
    @ManyToOne
    private TeacherOneToMany teacherOneToMany;
    ...
    public TeacherOneToMany getTeacher2() {
        return teacherOneToMany;
    }

    public void setTeacher2(TeacherOneToMany teacher2) {
        this.teacherOneToMany = teacher2;
    }
}
